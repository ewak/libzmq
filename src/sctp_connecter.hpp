...
#ifndef __SCTP_CONNECTER_HPP_INCLUDED__
#define __SCTP_CONNECTER_HPP_INCLUDED__
...
namespace zmq
{
    ...
    class sctp_connecter_t : public own_t, public io_object_t
    {
    public:
    ...
    private:
        ...
        sctp_connecter_t (const sctp_connecter_t&);
        const sctp_connecter_t &operator = (const sctp_connecter_t&);
    };
