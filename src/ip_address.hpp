...
#ifndef __ZMQ_IP_ADDRESS_HPP_INCLUDED__
#define __ZMQ_IP_ADDRESS_HPP_INCLUDED__
...
namespace zmq
{
    ...
    public:
        ...
        ip_address_t ();
        ip_address_t (const sockaddr *sa, socklen_t sa_len);
        virtual ~ip_address_t ();

        //  This function translates textual TCP/SCTP/UDP address into an address
        ...
        virtual int to_string (std::string &addr_, const std::string &protocol);
    ...
    class ip_address_mask_t : public ip_address_t
    {
    public:
        ip_address_mask_t ();

        // This function enhances ip_address_t::resolve() with ability to parse
        ...
        // The opposite to resolve()
        int to_string (std::string &addr_, const std::string& protocol);
