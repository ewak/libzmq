...
void zmq::tune_sctp_socket (fd_t s_)
{
#if 0
...
void zmq::set_sctp_send_buffer (fd_t sockfd_, int bufsize_)
{
...
void zmq::set_sctp_receive_buffer (fd_t sockfd_, int bufsize_)
{
...
void zmq::tune_sctp_keepalives (fd_t s_, int keepalive_, int keepalive_cnt_, int keepalive_idle_, int keepalive_intvl_)
{
#if 0
